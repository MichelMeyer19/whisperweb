          ...
          <div className="flex justify-center">
            <div className="w-60">
              ...
              <p className="font-light text-center">
                Please find your new chat in your chats page
              </p>
            </div>
          </div>
      ...
      <div className="mt-50">
        <div className="flex justify-center">
          <div className="w-60">
            ...
            <p className="font-light text-center">
              In case of an emergency, please feel free to read up on our
              information regarding student counselling at Copenhagen
              Universities in 'Information'
            </p>
          </div>
        </div>
      </div>
