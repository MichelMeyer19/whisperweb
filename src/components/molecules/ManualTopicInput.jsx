...
export const ManualTopicInput = ({ topics, setTopics }) => {
  ...
  function handleNewTopicLog(e) {
    ...
    if (newtopic.length > 3) {
      const old_and_new_topics = old_topics.concat([
        { id: topics.length.toString(), topic_name: newtopic, isClicked: true },
      ]);
    ...
    <div className="flex flex-col items-left">
      <div className="mx-2 flex ml-7">
        <input
          ...
          className="p-2 pl-1 text-sm text-gray-900 border border-gray-300 rounded-lg w-60 mr-4 focus:outline-none focus:border-black" // Added focus:outline-none and focus:border-black here
          value={newtopic}
